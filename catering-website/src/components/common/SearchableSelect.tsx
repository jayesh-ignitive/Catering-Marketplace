...
/**
 * Select2-style searchable single-select (react-select).
 * Shared by admin screens and public listing filters.
 */
...
function buildStyles(): StylesConfig<SelectOption, false> {
  return {
    control: (base, state) => ({
      ...base,
      minHeight: 42,
